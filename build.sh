...
zero_downtime_deploy() {  
  ...
  echo -e "${GREEN}Wait for new container to be available. ${NOCOLOR}"  
  ...
  echo -e "${GREEN}Start routing requests to the new container (as well as the old). ${NOCOLOR}"  
  reload_nginx

  # take the old container offline  
  echo -e "${GREEN}Take the old container offline. ${NOCOLOR}"  
  ...
  echo -e "${GREEN}Stop routing requests to the old container. ${NOCOLOR}"   
  reload_nginx  
}
